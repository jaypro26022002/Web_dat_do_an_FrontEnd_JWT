...
const Order = () => {
    ...
    const handleCheckout = async () => {
        const orderData = {
            ...
            total,
            paymentMethod: "MoMo",  // Always set to MoMo
...
//     const handleCheckout = async () => {
//         // Calculate total
//         const calculatedTotal = cart.reduce((acc, curr) => acc + Number(curr.price) * curr.qty, 0);
//         setTotal(calculatedTotal.toFixed(3));

//         // Check if total is less than 10000
//         if (calculatedTotal < 10000) {
//             alert("Quý khách phải mua hàng ít nhất 10.000đ để tiến hành thanh toán.");
//             return;
//         }
//         const orderData = {
//             items: cart.map(item => ({
