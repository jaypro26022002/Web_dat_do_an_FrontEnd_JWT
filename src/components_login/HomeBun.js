...
const HomeBunLogin = () => {
  ...
  useEffect(() => {
    ...
    const fetchShopComments = async () => {
      const data = await fetchComments4(4); // Assuming shop ID is 1
      setComments(data.DT);
    };
