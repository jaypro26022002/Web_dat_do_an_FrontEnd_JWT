...
const Order = () => {
    ...
    const handleCheckout = async () => {
        const orderData = {
            ...
            total,
            paymentMethod: "MoMo", // Directly set payment method to MoMo
            district,
    ...
    return (
        <div className="home">
                    ...
                    {cart.map((prod) => (
                        <ListGroup.Item key={prod.id_product}>
                            <Row>
                                ...
                                <Col md={2}>{Number(prod.price).toFixed(3)}₫</Col>
                                <Col md={2}>
            ...
            <div className="filters summary">
                ...
                <span style={{ fontWeight: 700, fontSize: 20 }}>Tổng tiền: {Number(total).toFixed(3)}₫</span>
                {/* Hiển thị phương thức thanh toán MoMo */}
                <div>
