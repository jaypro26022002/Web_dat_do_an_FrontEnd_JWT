...
const ModalProduct = (props) => {
    ...
    const handleConfirmProduct = async () => {
        ...
        if (check) {
            ...
            if (action === 'UPDATE') {
                formdata.append('id_product', productData.id_product);
            }
            ...
            <Modal.Body>
                <div className='content-body row'>
                    ...
                    <div className='col-12 col-sm-6 form-group'>
                        ...
                        <select
                            className={validInputs.collection ? 'form-control' : 'form-control is-invalid'}
                    ...
                    <div className='col-12 col-sm-6 form-group'>
                        ...
                        <select
                            className={validInputs.id_type_product ? 'form-control' : 'form-control is-invalid'}
